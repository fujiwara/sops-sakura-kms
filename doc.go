...
// to decrypt files.
//
//	addEnv, shutdown, err := ssk.RunServer(ctx, "127.0.0.1:0", keyID) // uses env vars, ephemeral port
//
// Or with a pre-configured saclient:
//
//	addEnv, shutdown, err := ssk.RunServer(ctx, "127.0.0.1:0", keyID, ssk.WithClient(client))
//	if err != nil {
//	    return err
//	}
